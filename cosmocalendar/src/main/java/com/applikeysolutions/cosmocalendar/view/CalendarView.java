...
public class CalendarView extends RelativeLayout implements OnDaySelectedListener,
    ...
    private void handleAttributes(TypedArray typedArray) {
        ...
        int otherDayTextColor = typedArray.getColor(R.styleable.CalendarView_otherDayTextColor, ContextCompat.getColor(getContext(), R.color.default_disabled_day_text_color));
        ...
        int connectedDayIconRes = typedArray.getResourceId(R.styleable.CalendarView_connectedDayIconRes, R.drawable.connected_icon);
        int connectedDaySelectedIconRes = typedArray.getResourceId(R.styleable.CalendarView_connectedDaySelectedIconRes, R.drawable.connected_icon);
...
//
//        Iterator<Day> i = month.getDays().iterator();
//        while (i.hasNext()) {
//            Day day = i.next(); // must be called before you can call i.remove()
//
//            if (String.valueOf(day.getCalendar().get(Calendar.YEAR)).equals("2017")) {
//                i.remove();
//            }
//        }
...
//            }
//        }
//        if (month.getFirstDay().getCalendar().get(Calendar.YEAR) != 2018 && month.getFirstDay().getCalendar().get(Calendar.YEAR) != 2020) {
